...
export namespace JSX {
  ...
  export interface DOMAttributes<T> extends CustomAttributes<T> {
     children?: Element;
     innerHTML?: string;
     innerText?: string;
     textContent?: string;
  ...
  export interface GraphicsElementSVGAttributes<T>
     extends CoreSVGAttributes<T>,
       Pick<
         ...
         | 'color-rendering'
       > {}
  export type LightSourceElementSVGAttributes<T> = CoreSVGAttributes<T>
  ...
  export type MetadataSVGAttributes<T> = CoreSVGAttributes<T>
